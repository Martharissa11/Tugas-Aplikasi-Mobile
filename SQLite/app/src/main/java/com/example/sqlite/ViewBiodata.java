...
//membuat kelas view biodata dengan mewarisi AppcompatActivity 
    protected Cursor cursor;
    //memanggil fungsi cursor
    DataHelper dbHelper;
    //memanggil fungsi data helper
    Button ton2;
    //memangil fungsi button
    TextView text1, text2, text3, text4, text5;
    //memanggil fungsi text view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //memberikan fungsi pada button back
